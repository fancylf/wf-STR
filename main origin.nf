...
reprot_name : $params.reprot_name
...
process minimap2 {
    ...
    """
        ...
        echo -e "${samplename}\t\$Pass_Reads\t\$Mapped_Reads\t\$Mapped_Reads_Rate\t\$Pass_Bases\t\$Mapped_Bases\t\$Mapped_Bases_Rate\t\$Depth" >> ${samplename}.map_stat.xls
    """
}
...
workflow {
    getParams()
    minimap2(params.fastq, params.reference_genome, params.minimap2_addition_para, params.samplename)
    grandSTR(params.fastq, params.reference_genome, params.minimap2_addition_para, params.samplename, params.target_STR_region)
